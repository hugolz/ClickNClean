    ...
    public AdminMainController(
        ...
        case 1: {
            ...
            if (status == 1) {
                ...
                connection.DAOaddActivity(ActivityType.CLEANER_ACCOUNT_CONFIRMED, cleanerId, null, cleanerId, null,
                                          null, 1);
        ...
        case 2: {
            ...
            if (status == 1) {
                ...
                connection.DAOaddActivity(ActivityType.DISPUTE_RESOLVED, cleanerId, ownerId, cleanerId, null,
                                          disputeId, 1);
                connection.DAOaddActivity(ActivityType.DISPUTE_RESOLVED, ownerId, ownerId, cleanerId, null,
                                          disputeId, 1);
                connection.disconnect();
            }
        ...
        for (Activity each : activitiesList) {
            ...
            if (each.getType() == ActivityType.CLEANER_WAITING_TO_BE_CONFIRMED) {
                ...
                if (currentCleaner.isConfirmedId() == false && currentCleaner.isSuspended() == false) {
                    ...
                    // System.out.println("entered in activity " +
                    // activitiesList.get(0).getActivityId() + "cleaner is : " +
                    // currentCleaner.getCleanerId());
                }
